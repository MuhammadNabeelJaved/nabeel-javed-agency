...
import {
  ...
  CreditCard, Bot, HelpCircle, Bell, ChevronRight, Briefcase, PenTool,
          ...
          <AnimatePresence initial={false}>
            {showText && (
              <motion.div
                key="menu-label"
                initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                className="px-3 mb-3 hidden lg:block"
              >
                    ...
                    <AnimatePresence initial={false}>
                      {showText && (
                        <motion.span
                          ...
                          className="hidden lg:flex items-center gap-2 font-medium text-sm flex-1 overflow-hidden whitespace-nowrap"
                        >
                          {link.name}
