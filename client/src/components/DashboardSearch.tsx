...
const ADMIN_ITEMS: SearchItem[] = [
  ...
  { id: 'a-billing',     label: 'Billing',                description: 'Invoices & payments',            path: '/admin/billing',           icon: CreditCard,      group: 'Pages',   keywords: ['invoices', 'payments', 'subscriptions'] },
  { id: 'a-support',     label: 'Support',                description: 'Help & tickets',                 path: '/admin/support',           icon: HelpCircle,      group: 'Pages',   keywords: ['help', 'tickets', 'issues'] },
