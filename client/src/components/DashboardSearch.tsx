...
const ADMIN_ITEMS: SearchItem[] = [
  ...
  { id: 'a-ce-about',     label: 'About Page Content',     description: 'Content Editor → About Page',   path: '/admin/content-editor?tab=about',          icon: PenTool,   group: 'Content Sections', keywords: ['about', 'stats', 'story', 'milestones', 'values', 'timeline', 'company'] },
  { id: 'a-ce-privacy',   label: 'Privacy Policy',         description: 'Content Editor → Privacy Policy', path: '/admin/content-editor?tab=privacy',         icon: PenTool,   group: 'Content Sections', keywords: ['privacy', 'gdpr', 'data', 'personal', 'legal', 'policy'] },
  { id: 'a-ce-terms',     label: 'Terms of Service',       description: 'Content Editor → Terms',          path: '/admin/content-editor?tab=terms',           icon: PenTool,   group: 'Content Sections', keywords: ['terms', 'tos', 'service', 'legal', 'agreement', 'license'] },
  { id: 'a-ce-cookies',   label: 'Cookies Policy',         description: 'Content Editor → Cookies Policy', path: '/admin/content-editor?tab=cookies-policy',  icon: PenTool,   group: 'Content Sections', keywords: ['cookies', 'consent', 'gdpr', 'functional', 'analytics', 'marketing'] },
  // Quick actions
