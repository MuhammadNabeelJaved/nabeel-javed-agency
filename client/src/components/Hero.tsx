...
export function Hero() {
  ...
  return (
    <div className="relative overflow-hidden flex items-center justify-center bg-background pt-4 pb-0 sm:min-h-screen sm:pt-0 sm:pb-32 md:pb-40">
      {/* Background Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-2 sm:pt-20">
